...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        (out_affine_relu,cache_affine_relu) = affine_relu_forward(X,W1,b1)
        (out_affine_forward,cache_affine_forward) = affine_forward(out_affine_relu,W2,b2)
        scores = out_affine_forward
        ############################################################################
        ...
        if y is None:
            return scores
        (loss,dout_affine_forward)=softmax_loss(scores,y)
        (dout_affine_relu_forward,dw2,db2)=affine_backward(dout_affine_forward,cache_affine_forward)
        (dx,dw1,db1)=affine_relu_backward(dout_affine_relu_forward,cache_affine_relu)
        ...
        grads = {}
        grads['W1'],grads['b1'],grads['W2'],grads['b2'] = dw1+self.reg*W1,db1,dw2+self.reg*W2,db2
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        #     print("{}".format(weight),self.params[weight].shape)
